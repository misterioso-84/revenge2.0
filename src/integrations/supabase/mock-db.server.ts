...
function getInitialDb() {
  ...
  const db: Record<string, any[]> = {
    ...
    board_categories: [
      {
        id: "cat-direzione",
        name: "Direzione & Vertice",
        description:
          "Direttive aziendali, delibere, circolari ufficiali e coordinamento generale Casinò Revenge.",
        icon: "Crown",
        color: "#f59e0b",
        sort_order: 1,
        created_by: "mock-user-id-1234",
        created_by_name: "Direzione Generale",
        created_at: new Date(Date.now() - 86400000 * 7).toISOString(),
      },
      {
        id: "cat-eventi",
        name: "Eventi, Gare & Spettacoli",
        description:
          "Pianificazione grandi eventi, gare ippiche, tornei di gala e coordinamento animazione.",
        icon: "Sparkles",
        color: "#a855f7",
        sort_order: 2,
        created_by: "mock-user-id-1234",
      ...
      {
        id: "cat-cassa",
        name: "Cassa & Contabilità",
        description:
          "Verbali di apertura/chiusura, quadratura fiches e dobloni, conversioni e cassette.",
        icon: "Coins",
        color: "#10b981",
        sort_order: 3,
        created_by: "mock-user-id-1234",
      ...
      {
        id: "cat-operativo",
        name: "Staff & Sale da Gioco",
        description:
          "Turni, mansioni operative, briefing croupier, sicurezza e assistenza clienti.",
        icon: "Shield",
        color: "#3b82f6",
        sort_order: 4,
        created_by: "mock-user-id-1234",
      ...
      {
        id: "cat-idee",
        name: "Proposte & Idee di Sviluppo",
        description:
          "Bacheca aperta a proposte di miglioramento, idee per nuovi giochi e innovazioni.",
        icon: "Lightbulb",
        color: "#ec4899",
        sort_order: 5,
        created_by: "mock-user-id-1234",
    ...
    board_subcategories: [
      {
        id: "sub-dir-comunicazioni",
        category_id: "cat-direzione",
        name: "Circolari & Direttive Ufficiali",
        description: "Comunicazioni ufficiali della Direzione Generale vincolanti per lo staff.",
        icon: "FileText",
        color: "#f59e0b",
        sort_order: 1,
        allowed_roles: [],
      ...
      },
      {
        id: "sub-dir-riunioni",
        category_id: "cat-direzione",
        name: "Riunioni di Vertice & Assemblee",
        description: "Convocazioni riunioni generali e verbali delle decisioni di vertice.",
        icon: "CalendarDays",
        color: "#f59e0b",
        sort_order: 2,
        allowed_roles: [],
      ...
      },
      {
        id: "sub-dir-task",
        category_id: "cat-direzione",
        name: "Obiettivi & Task Strategici",
        description: "Task e scadenze strategiche a medio-lungo termine per il Casinò.",
        icon: "CheckSquare",
        color: "#f59e0b",
        sort_order: 3,
        allowed_roles: [],
      ...
      {
        id: "sub-ev-programma",
        category_id: "cat-eventi",
        name: "Programmazione Serate & Gare",
        description: "Calendario prossimi tornei, gare ippiche ed eventi speciali.",
        icon: "Trophy",
        color: "#a855f7",
        sort_order: 1,
        allowed_roles: [],
      ...
      },
      {
        id: "sub-ev-task",
        category_id: "cat-eventi",
        name: "Task Allestimento & Logistica",
        description: "Incarichi operativi per preparazione stand, premi e percorsi gara.",
        icon: "CheckSquare",
        color: "#a855f7",
        sort_order: 2,
        allowed_roles: [],
      ...
      {
        id: "sub-cassa-note",
        category_id: "cat-cassa",
        name: "Verbali & Note di Turno Cassa",
        description: "Aggiornamenti sui cambi turno cassa, anomalie e quadrature dobloni.",
        icon: "Banknote",
        color: "#10b981",
        sort_order: 1,
        allowed_roles: [],
      ...
      },
      {
        id: "sub-cassa-task",
        category_id: "cat-cassa",
        name: "Task Riconciliazioni & Verifiche",
        description: "Compiti di conteggio fiches, audit cassette e controllo plafond.",
        icon: "CheckSquare",
        color: "#10b981",
        sort_order: 2,
        allowed_roles: [],
      ...
      {
        id: "sub-op-briefing",
        category_id: "cat-operativo",
        name: "Briefing di Turno & Sale",
        description: "Note operative giornaliere per croupier, addetti alla sala e bar.",
        icon: "Clock",
        color: "#3b82f6",
        sort_order: 1,
        allowed_roles: [],
      ...
      },
      {
        id: "sub-op-task",
        category_id: "cat-operativo",
        name: "Task Assegnate allo Staff",
        description: "Compiti con scadenza assegnati ai singoli collaboratori in servizio.",
        icon: "CheckSquare",
        color: "#3b82f6",
        sort_order: 2,
        allowed_roles: [],
      ...
      {
        id: "sub-idee-generale",
        category_id: "cat-idee",
        name: "Nuove Idee & Brainstorming",
        description: "Spazio aperto per suggerimenti, feedback e nuove proposte di gioco.",
        icon: "Sparkles",
        color: "#ec4899",
        sort_order: 1,
        allowed_roles: [],
    ...
    board_items: [
      {
        id: "item-meet-1",
        category_id: "cat-direzione",
        subcategory_id: "sub-dir-riunioni",
        type: "meeting",
        title: "Riunione Straordinaria di Staff - Pianificazione Serata VIP & Nuovi Tornei",
        content:
          "Ordine del giorno:\n1. Analisi incassi settimanali e quadratura conversioni dobloni\n2. Organizzazione torneo di Gala e premi speciali\n3. Revisione mansioni croupier e sicurezza sale",
        is_pinned: true,
        priority: "high",
        meeting_date: new Date(Date.now() + 86400000 * 2).toISOString(),
        meeting_location: "Discord Ufficiale / Sala Riunioni Direzione",
        meeting_status: "scheduled",
        attendees_ids: ["mock-user-id-1234"],
        attendees_names: ["Amministrazione", "Capo Cassa", "Capitano Staff"],
        author_id: "mock-user-id-1234",
        author_name: "Direzione Generale",
        author_role: "Amministratore",
        created_at: new Date(Date.now() - 3600000 * 2).toISOString(),
        updated_at: new Date(Date.now() - 3600000 * 2).toISOString(),
      },
      {
        id: "item-note-pinned-1",
        category_id: "cat-direzione",
        subcategory_id: "sub-dir-comunicazioni",
        type: "note",
        title: "Direttiva Ufficiale: Verifica Tessere VIP e Nuovi Tetti di Conversione Dobloni",
        content:
          "Si ricorda a tutto il personale in servizio che è obbligatorio verificare la tessera VIP prima di consentire l'accesso alla Sala Privé. I massimali giornalieri di cambio valuta sono fissati a 10.000 Dobloni e 2.000 € al giorno per utente.",
        is_pinned: true,
        priority: "high",
        tags: ["Direttiva", "Ufficiale", "VIP"],
        author_id: "mock-user-id-1234",
        author_name: "Direzione Generale",
        author_role: "Amministratore",
        created_at: new Date(Date.now() - 3600000 * 5).toISOString(),
      ...
      },
      {
        id: "item-task-1",
        category_id: "cat-operativo",
        subcategory_id: "sub-op-task",
        type: "task",
        title: "Verifica e Collaudo Tavoli Roulette e Rifornimento Fiches",
        content:
          "Eseguire il controllo di bilanciamento delle ruote della roulette nei tavoli 1 e 2, verificare la scorta di fiches nei cassetti cassa e compilare la scheda di apertura.",
        is_pinned: false,
        priority: "urgent",
        task_status: "in_progress",
        deadline: new Date(Date.now() + 86400000).toISOString(),
        assigned_to_ids: ["mock-user-id-1234"],
        assigned_to_names: ["Amministratore"],
        checklist: [
          { id: "chk-1", text: "Verifica integrità panno e roulette", done: true },
          { id: "chk-2", text: "Controllo scorta fiches sala", done: true },
          { id: "chk-3", text: "Registrazione tagliandi cassa", done: false },
        ],
        author_id: "mock-user-id-1234",
        author_name: "Capitano Sala",
        author_role: "Staff",
      ...
      },
      {
        id: "item-task-2",
        category_id: "cat-cassa",
        subcategory_id: "sub-cassa-task",
        type: "task",
        title: "Quadratura Registro Conversioni e Riconciliazione Cassette di Sicurezza",
        content:
          "Effettuare il controllo incrociato tra i tagliandi di conversione emessi nell'ultimo turno e i depositi registrati nelle cassette.",
        is_pinned: false,
        priority: "medium",
        task_status: "todo",
        ...
        assigned_to_names: ["Amministratore"],
        checklist: [
          { id: "chk-21", text: "Download report giornaliero conversioni", done: false },
          {
            id: "chk-22",
            text: "Controllo corrispondenza dobloni fisici in cassaforte",
            done: false,
          },
        ],
        author_id: "mock-user-id-1234",
        author_name: "Responsabile Contabilità",
        author_role: "Staff",
      ...
      },
      {
        id: "item-note-idee-1",
        category_id: "cat-idee",
        subcategory_id: "sub-idee-generale",
        type: "note",
        title: "Proposta: Introduzione Torneo Settimanale Blackjack Special Edition",
        content:
          "Si propone di dedicare il venerdì sera a un torneo a eliminazione diretta di Blackjack con montepremi in Dobloni e trofeo celebrativo per i primi 3 classificati.",
        is_pinned: false,
        priority: "low",
        tags: ["Proposta", "Blackjack", "Torneo"],
        author_id: "mock-user-id-1234",
        author_name: "Croupier Senior",
        author_role: "Staff",
        created_at: new Date(Date.now() - 86400000 * 2).toISOString(),
        updated_at: new Date(Date.now() - 86400000 * 2).toISOString(),
      },
