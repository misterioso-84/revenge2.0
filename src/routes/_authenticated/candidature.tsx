...
function CandidaturePage() {
  const { user, profile, isAdmin, permissions = [], customRoleNames = [] } = useAuth();
  ...
  return (
    <div className="space-y-8 py-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-slate-400 text-xs">
                I dati del questionario sono salvati in automatico. Puoi riprendere l'editing in
                qualsiasi momento!
              </span>
            </div>
          </div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Seleziona il modulo per candidarti. Puoi inviare al massimo una candidatura per
                  ciascun bando.
                </p>
              </div>
            </div>
          ...
          {isLoadingForms ? (
            ...
            <div className="p-12 text-center bg-[#12141c] border border-slate-800 rounded-2xl space-y-3">
              ...
              <h3 className="text-sm font-bold text-slate-300">Nessun bando aperto al momento</h3>
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                Attualmente non ci sono moduli attivi per nuove candidature. Controlla regolarmente
                per nuove aperture.
              </p>
            </div>
          ) : (
                        ...
                        <div className="flex items-center justify-between w-full gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            >
                              ...
                              {existingSubmission.status === "under_review" && "⏳ In Valutazione"}
                              {existingSubmission.status === "pending" && "⏳ Inviata (In Attesa)"}
                            </Badge>
                          </div>
        ...
        <div className="space-y-6">
          <div className="bg-[#12141c] border border-slate-800/90 rounded-2xl p-5 sm:p-6 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Riepilogo e stato in tempo reale di tutte le domande inviate per entrare nello
                  Staff del Casinò
                </p>
              </div>
            </div>
          ...
          {isLoadingMySubs ? (
            ...
            <div className="p-12 text-center bg-[#12141c] border border-slate-800 rounded-2xl space-y-3">
              ...
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                Consulta i bandi aperti per inviare la tua domanda ed entrare a far parte della
                squadra del Casinò Revenge.
              </p>
              <Button
                onClick={() => setActiveTab("available")}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          ...
                          {sub.status === "rejected" && <XCircle className="h-3.5 w-3.5 mr-1" />}
                          {sub.status === "under_review" && <Clock className="h-3.5 w-3.5 mr-1" />}
      ...
      {canReview && activeTab === "evaluations" && (
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-[#12141c] border border-slate-800/90 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 shadow-lg">
            ...
            {/* Status Filter */}
            <div>
              <Select value={evalStatusFilter} onValueChange={(val) => setEvalStatusFilter(val)}>
                <SelectTrigger className="bg-[#0a0b10] border-slate-800 text-white text-xs rounded-xl h-10">
          ...
          {isLoadingAllApps ? (
            ...
            <div className="p-12 text-center bg-[#12141c] border border-slate-800 rounded-2xl space-y-2">
              <ClipboardList className="h-10 w-10 text-slate-600 mx-auto" />
              <h3 className="text-sm font-bold text-slate-300">Nessuna candidatura trovata</h3>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2 flex-wrap">
                          <h4 className="text-sm font-black text-white">{app.applicant_name}</h4>
                          <button
                            type="button"
                    ...
                    <div className="flex items-center gap-3 justify-between md:justify-end border-t md:border-t-0 pt-3 md:pt-0 border-slate-800">
                      ...
                      >
                        {app.status === "accepted" && <CheckCircle2 className="h-3.5 w-3.5 mr-1" />}
                        {app.status === "rejected" && <XCircle className="h-3.5 w-3.5 mr-1" />}
                        {app.status === "under_review" && <Clock className="h-3.5 w-3.5 mr-1" />}
        ...
        <div className="space-y-6">
          <div className="bg-[#12141c] border border-slate-800/90 rounded-2xl p-5 sm:p-6 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Crea e configura i moduli di candidatura, personalizza le domande e gestisci lo
                  stato di apertura
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {forms.map((f) => {
              ...
              const acceptedCount = subsForThisForm.filter((a) => a.status === "accepted").length;
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-center gap-4 text-xs text-slate-400 pt-1 flex-wrap font-medium">
                        <span>
                          Ruolo Target: <strong className="text-amber-400">{f.role_target}</strong>
                        </span>
                        <span>•</span>
                        ...
                        <span>•</span>
                        <span className="text-amber-400 font-bold">{pendingCount} in attesa</span>
                      </div>
                    </div>
      ...
      <ReviewApplicationDialog
        ...
        currentUserId={user?.id}
        reviewerName={profile?.display_name || user?.user_metadata?.display_name || "Valutatore"}
      />
